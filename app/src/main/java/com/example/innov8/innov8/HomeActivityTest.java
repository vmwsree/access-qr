...
// If there are paired devices
    ...
    public void showDialog()
    {
        ...
        LayoutInflater li = LayoutInflater.from(HomeActivityTest.this);
        View promptsView = li.inflate(R.layout.searchprompt, null);
        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(HomeActivityTest.this);
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (user_text.equals("renuravi01")) {
                                    ...
                                    AlertDialog.Builder builder = new AlertDialog.Builder(HomeActivityTest.this);
        ...
        if(requestCode!=1){
            ...
            if(result != null) {
                if(result.getContents() == null) {
                    ...
                    Intent intent = new Intent(HomeActivityTest.this, ParseActivity.class);
